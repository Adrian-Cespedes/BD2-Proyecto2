...
class Mongo:
    ...
    def explain_retrieve_time_millis(self, query, k):
        ...
        print(
            explain_result.get("executionStats")
            .get("executionStages")
            .get("executionTimeMillisEstimate")
        )
...
if __name__ == "__main__":
    ...
    for i in N:
        ...
        mongo = Mongo(data)
        results[i] = (
            mongo.explain_retrieve_time_millis(query, k) / 1000
        )  # comvertir a segundos
    print(results)
